  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="relative h-full bg-primary-bg/80 backdrop-blur-sm border border-text-secondary/15 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="relative z-10 p-6 h-full flex flex-col">
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <motion.div
                  className="ml-3 p-2 bg-text-secondary/10 rounded-xl"
        ...
        {/* Back of Card */}
        <motion.div
          className="absolute inset-0 w-full h-full backface-hidden transform rotateY-180"
            ...
            <div className="h-full flex flex-col p-6">
              ...
              <div className="mt-auto">
                <motion.a
                  ...
                  className="flex items-center justify-center w-full px-4 py-3 bg-accent-1 hover:bg-accent-1/90 text-primary-bg rounded-xl font-mono text-sm tracking-wide transition-all duration-300 shadow-lg hover:shadow-accent-1/30"
...
const FilterButton = ({ category, isActive, onClick }) => (
  <motion.button
    ...
    className={`px-5 py-2 rounded-xl font-mono text-sm transition-all duration-300 ${
      isActive
...
const Certifications = () => {
  ...
  // Memoize categories to ensure they're stable
  ...
  // Reset category if it becomes invalid
  React.useEffect(() => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {filteredCertifications.length === 0 && (
          ...
          >
            ...
            <h3 className="text-xl font-mono text-text-primary mb-2">No certifications in this category</h3>
